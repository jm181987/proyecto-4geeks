			...
			<div className="row md justify-content-center " >
				...
				<div className="row md justify-content-center t-5 ">
					...
					<div className="col md mb-3 text-white ">
						<h3 >
							Ser el líder en la industria de contratación de artistas en línea, brindando una experiencia excepcional a ambos artistas y clientes a través de un servicio personalizado y tecnología innovadora.
						</h3><br/>
					</div>
				</div>
			</div>
